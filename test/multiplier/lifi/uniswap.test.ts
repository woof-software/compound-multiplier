...
import { CometFoundation, UniswapV3Plugin, LiFiPlugin, IComet, IERC20 } from "../../../typechain-types";
    ...
    describe("Execute and Withdraw with AllowBySig", function () {
        it("should execute leveraged position with allowBySig (no prior authorization)", async function () {
            ...
            await adapter
                ...
                ](market, WETH_ADDRESS, initialAmount, leverage, 100, swapData, allowParams, opts);
