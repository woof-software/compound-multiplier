...
import { CometMultiplier, UniswapV3Plugin, OneInchV6SwapPlugin, IComet, IERC20 } from "../../../typechain-types";
...
describe.skip("Comet Multiplier Adapter / 1inch / UniswapV3", function () {
    ...
    describe("Execute Multiplier", function () {
        ...
        it("should revert with insufficient allowance", async function () {
            ...
            await expect(adapter.connect(user2).executeMultiplier(market, WETH_ADDRESS, initialAmount, leverage, "0x"))
                .to.be.reverted;
        });
        ...
        it("should revert with zero collateral amount", async function () {
            ...
            await expect(adapter.connect(user).executeMultiplier(market, WETH_ADDRESS, initialAmount, leverage, "0x"))
                .to.be.reverted;
        });
