...
/**
 * @title IFlashLoanPlugin
 * @notice Interface for flash loan plugins used in Compound V3 operations
 */
interface IFlashLoanPlugin is IERC165 {
     ...
     */
    function takeFlashLoan(IS.CallbackData memory data, bytes memory) external payable;
