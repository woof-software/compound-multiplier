...
interface IStructs {
     ...
     * @param market The address of the lending market contract (e.g., Comet, Morpho singleton)
     * @param corePlugin The address of the core lending protocol plugin (handles supply/withdraw/borrow)
     * @param loanPlugin The address of the flash loan plugin contract
     * @param swapPlugin The address of the swap plugin contract
     * @param coreConfig Encoded configuration specific to the core plugin (e.g., Morpho market params)
     */
    struct Options {
        address market;
        address corePlugin;
