 ...
 * @dev Implements ISwapPlugin interface for OKX dagSwap routing
 */
contract OKXPlugin is ISwapPlugin {
    ...
    function swap(
        ...
        require(router.code.length > 0, IA.InvalidSwapParameters());
        require(approveProxy.code.length > 0, IA.InvalidSwapParameters());
        ...
        require(amountOut >= minReturn, IA.InvalidAmountOut());
    ...
    function _decodeAndValidateDagSwap(
        ...
        require(receiver == address(this), IA.InvalidReceiver());
        require(baseRequest.minReturnAmount != 0, IA.InvalidSwapParameters());
        require(baseRequest.fromTokenAmount == amountIn, IA.InvalidSwapParameters());
        require(paths.length > 0, IA.InvalidSwapParameters());
    ...
    function _decodeAndValidateUniV3Swap(
        ...
        require(receiver == address(this), IA.InvalidReceiver());
        require(minReturn != 0, IA.InvalidSwapParameters());
        require(amount == amountIn, IA.InvalidSwapParameters());
    ...
    function _decodeAndValidateUnxSwap(
        ...
        require(minReturn != 0, IA.InvalidSwapParameters());
        require(amount == amountIn, IA.InvalidSwapParameters());
        require(uint160(fromToken) == uint160(srcToken), IA.InvalidTokens());
    }
